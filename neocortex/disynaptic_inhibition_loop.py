...
netParams.synMechParams['excite_pyr_pre'] = {'mod': 'Exp2Syn', 'tau1': 0.1, 'tau2': 5, 'e': 0}  # excitatory synaptic mechanism
...
netParams.stimSourceParams['CurrentClamp'] = {
    'type': 'IClamp',
    'amp': 0.2,  # amplitude of current, in nA
...
netParams.connParams['PYR->SST'] = {
    'preConds': {'pop': 'pre'},
    'postConds': {'pop': 'sst'},
    'weight': 0.000037,  # Not really sure about the weight parameter values used for the parameters, waiting for adjustment. It seems like increasing the weight value will decrease the amplitude of the EPSPs
...
netParams.connParams['SST->PYR'] = {
    'preConds': {'pop': 'sst'},
    'postConds': {'pop': 'post'},
    'weight': 0.00025,  # Not really sure about the weight parameter values used for the parameters, waiting for adjustment
    'delay': 50, # Millisecond delay between when the pre-synaptic neuron fires and when that signal affects the post-synaptic neuron  
