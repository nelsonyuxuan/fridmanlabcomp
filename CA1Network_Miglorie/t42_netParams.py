...
# Random seed given from the cfg file 
...
# If the population size is greater than zero, than import the cell morphology and set the corresponding population parameters
...
# All other membrane mechanisms are implemented in the hoc files
...
# Load morphology from the morphology of each cell
# Obtain the section list for each type from each cell alos obtain the corresponding 3d coordinates
