...
#define a0n _p[1]
#define a0n_columnindex 1
#define sh _p[2]
#define sh_columnindex 2
#define tau_s _p[3]
#define tau_s_columnindex 3
#define taun_fix _p[4]
#define taun_fix_columnindex 4
#define gkdr _p[5]
#define gkdr_columnindex 5
#define n _p[6]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrb kdrbca1.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 48 in file kdrbca1.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdrbca1.mod";
static const char* nmodl_file_text = 
  "TITLE K-DR channel\n"
  ...
  "        RANGE gkdr,gkdrbar, sh, a0n, tau_s, taun_fix\n"
  "	GLOBAL ninf,taun\n"
  "}\n"
  "\n"
  "STATE {\n"
